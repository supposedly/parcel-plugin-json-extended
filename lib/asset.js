 ...
 */
class JSONURLOrDataLoader extends JSONAsset {
    
    generate() {
        // hacky hacky hacky
        // goal is to have no default export in case the JSON object has a 'url' attribute
        return super.generate().replace('module.exports', 'module.exports={};exports.data') + `exports.url = ${
            urlJoin(
...
module.exports = JSONURLOrDataLoader;
